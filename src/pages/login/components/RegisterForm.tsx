...
const RegisterForm: React.FC<RegisterFormProps> = ({ onSuccess, onSwitchToLogin }) => {
    ...
    const [errors, setErrors] = useState<Partial<RegisterReq & { confirmPassword: string }>>({});
    ...
    const handleInputChange = (field: keyof (RegisterReq & { confirmPassword: string }), value: string) => {
