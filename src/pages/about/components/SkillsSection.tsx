...
const SkillsSection: React.FC = () => {
  const frontendSkills = [
    { name: 'React', level: 50, color: 'from-blue-500 to-cyan-500', icon: '⚛️' },
    { name: 'TypeScript', level: 50, color: 'from-blue-600 to-indigo-600', icon: '📘' },
    { name: 'Vue.js', level: 50, color: 'from-green-500 to-emerald-500', icon: '💚' },
  ...
  const backendSkills = [
    { name: 'Golang', level: 70, color: 'from-green-600 to-lime-600', icon: '🟢' },
    { name: 'MySQL', level: 50, color: 'from-green-500 to-teal-500', icon: '🍃' },
    { name: 'Redis', level: 50, color: 'from-blue-700 to-indigo-700', icon: '🐘' },
    { name: 'Docker', level: 30, color: 'from-pink-500 to-rose-500', icon: '🔗' },
    { name: 'Elasticsearch', level: 50, color: 'from-blue-500 to-blue-700', icon: '🐳' },
    { name: 'Kafka', level: 10, color: 'from-pink-500 to-rose-500', icon: '🔗' }
  ];

  const toolsSkills = [
    { name: 'Git', level: 20, color: 'from-orange-500 to-red-500', icon: '📂' },
    { name: 'Cursor', level: 50, color: 'from-blue-600 to-purple-600', icon: '💻' },
    { name: 'Linux', level: 20, color: 'from-purple-500 to-indigo-500', icon: '🎨' },
  ];
